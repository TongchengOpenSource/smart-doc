...
/**
 * This class is copied from the Spring Framework project. Original package:
 * org.springframework.http Source URL: <a href=
 * "https://github.com/spring-projects/spring-framework/blob/main/spring-web/src/main/java/org/springframework/http/HttpStatus.java">org.springframework.http.HttpStatus</a>
 * <p>
...
public enum HttpStatusEnum {
	 ...
	 * <p>
	 * Retrievable via {@link HttpStatusEnum#series()}.
	 */
	public enum Series {
		 ...
		 * @return the {@code Series} enum constant for the supplied {@code HttpStatus}
		 * @deprecated as of 5.3, in favor of invoking {@link HttpStatusEnum#series()}
		 * directly
		 */
		@Deprecated

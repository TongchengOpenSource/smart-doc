...
/**
 * This class is copied from the Spring Framework project.
 * Original package: org.springframework.http
 * Source URL: <a href="https://github.com/spring-projects/spring-framework/blob/main/spring-web/src/main/java/org/springframework/http/HttpStatus.java">org.springframework.http.HttpStatus</a>
 * <p>
...
public enum HttpStatusEnum {
    ...
    private static final HttpStatusEnum[] VALUES;
     ...
     *
     * @return the reason phrase (never {@code null})
     */
     ...
     * {@link HttpStatusEnum.Series#INFORMATIONAL}.
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link HttpStatusEnum.Series#SUCCESSFUL}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     *
     * @return boolean
     * @see #series()
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link HttpStatusEnum.Series#REDIRECTION}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     *
     * @return boolean
     * @see #series()
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link HttpStatusEnum.Series#CLIENT_ERROR}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     *
     * @return boolean
     * @see #series()
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link HttpStatusEnum.Series#SERVER_ERROR}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     *
     * @return boolean
     * @see #series()
    ...
    /**
     * Whether this status code is in the HTTP series
     * {@link HttpStatusEnum.Series#CLIENT_ERROR} or
     * {@link HttpStatusEnum.Series#SERVER_ERROR}.
     * <p>This is a shortcut for checking the value of {@link #series()}.
     *
     * @return boolean
     ...
     * <p>Retrievable via {@link HttpStatusEnum#series()}.
     */
    public enum Series {
         ...
         * @return the {@code Series} enum constant for the supplied {@code HttpStatus}
         * @deprecated as of 5.3, in favor of invoking {@link HttpStatusEnum#series()} directly
         */
        @Deprecated

...
public class ApiReqParam {
	...
	/**
	 * where is param location default header
	 *
	...
	/**
	 * @since 2.2.2 Regular expression match request param
	 */
	...
	public String toString() {
		...
		sb.append(",\"pathPatterns\":\"").append(pathPatterns).append('\"');
		sb.append(",\"excludePathPatterns\":\"").append(excludePathPatterns).append('\"');
		sb.append('}');
		return sb.toString();
	}
